...
var _user$project$Form_Value$isChanged = function (value) {
	var _p0 = value;
	if (_p0.ctor === 'Changed') {
		return true;
	} else {
...
var _user$project$Form_Value$getOriginalValue = function (value) {
	var _p1 = value;
	if (_p1.ctor === 'Unchanged') {
		return _p1._0;
	} else {
		return _p1._0;
	}
};
var _user$project$Form_Value$getValue = function (value) {
	var _p2 = value;
	if (_p2.ctor === 'Unchanged') {
		return _p2._0;
	} else {
		return _p2._1;
	}
};
var _user$project$Form_Value$Changed = F2(
	function (a, b) {
		return {ctor: 'Changed', _0: a, _1: b};
	});
var _user$project$Form_Value$Unchanged = function (a) {
	return {ctor: 'Unchanged', _0: a};
};
var _user$project$Form_Value$init = _user$project$Form_Value$Unchanged;
var _user$project$Form_Value$update = F2(
	function (newValue, current) {
		var _p3 = current;
		if (_p3.ctor === 'Unchanged') {
			var _p5 = _p3._0;
			var _p4 = _elm_lang$core$Native_Utils.eq(newValue, _p5);
			if (_p4 === true) {
				return current;
			} else {
				return A2(_user$project$Form_Value$Changed, _p5, newValue);
			}
		} else {
			var _p8 = _p3._0;
			var _p6 = _elm_lang$core$Native_Utils.eq(_p3._1, newValue);
			if (_p6 === true) {
				return current;
			} else {
				var _p7 = _elm_lang$core$Native_Utils.eq(_p8, newValue);
				if (_p7 === true) {
					return _user$project$Form_Value$Unchanged(_p8);
				} else {
					return A2(_user$project$Form_Value$Changed, _p8, newValue);
				}
			}
		}
	});
var _user$project$Form_Value$reset = function (_p9) {
	return _user$project$Form_Value$Unchanged(
		_user$project$Form_Value$getOriginalValue(_p9));
};

var _user$project$Form_TextInput$getIsChanged = function (_p0) {
	var _p1 = _p0;
	return _user$project$Form_Value$isChanged(_p1._0.value);
};
var _user$project$Form_TextInput$getValue = function (_p2) {
	var _p3 = _p2;
	return _user$project$Form_Value$getValue(_p3._0.value);
};
var _user$project$Form_TextInput$initialViewState = {isShown: true, isLocked: false, isError: false};
var _user$project$Form_TextInput$InternalState = function (a) {
	return {value: a};
};
var _user$project$Form_TextInput$ViewState = F3(
	function (a, b, c) {
		return {isShown: a, isLocked: b, isError: c};
	});
var _user$project$Form_TextInput$Model = function (a) {
	return {ctor: 'Model', _0: a};
};
var _user$project$Form_TextInput$init = _user$project$Form_TextInput$Model(
	{
		value: _user$project$Form_Value$init('')
	});
var _user$project$Form_TextInput$update = F2(
	function (_p5, _p4) {
		var _p6 = _p5;
		var _p7 = _p4;
		var _p8 = _p7._0;
		return _user$project$Form_TextInput$Model(
			_elm_lang$core$Native_Utils.update(
				_p8,
				{
					value: A2(_user$project$Form_Value$update, _p6._0, _p8.value)
				}));
	});
var _user$project$Form_TextInput$setValue = F2(
	function (value, _p9) {
		var _p10 = _p9;
		return _user$project$Form_TextInput$Model(
			_elm_lang$core$Native_Utils.update(
				_p10._0,
				{
					value: _user$project$Form_Value$init(value)
				}));
	});
var _user$project$Form_TextInput$reInitialize = function (_p11) {
	var _p12 = _p11;
	var _p13 = _p12._0;
	return _user$project$Form_TextInput$Model(
		_elm_lang$core$Native_Utils.update(
			...
			{
				value: _user$project$Form_Value$init(
					_user$project$Form_Value$getValue(_p13.value))
			}));
};
var _user$project$Form_TextInput$reset = function (_p14) {
	var _p15 = _p14;
	var _p16 = _p15._0;
	return _user$project$Form_TextInput$Model(
		_elm_lang$core$Native_Utils.update(
			_p16,
			{
				value: _user$project$Form_Value$reset(_p16.value)
			}));
};
var _user$project$Form_TextInput$View = F2(
	function (a, b) {
		return {ctor: 'View', _0: a, _1: b};
	});
var _user$project$Form_TextInput$view = function (_p17) {
	var _p18 = _p17;
	return A2(_user$project$Form_TextInput$View, _user$project$Form_TextInput$initialViewState, _p18._0);
};
var _user$project$Form_TextInput$viewIf = F2(
	function (isShown, _p19) {
		var _p20 = _p19;
		return A2(
			_user$project$Form_TextInput$View,
			_elm_lang$core$Native_Utils.update(
				_user$project$Form_TextInput$initialViewState,
				{isShown: isShown}),
			_p20._0);
	});
var _user$project$Form_TextInput$setIsLocked = F2(
	function (isLocked, _p21) {
		var _p22 = _p21;
		return A2(
			_user$project$Form_TextInput$View,
			_elm_lang$core$Native_Utils.update(
...
var _user$project$Form_TextInput$setIsError = F2(
	function (isError, _p23) {
		var _p24 = _p23;
		return A2(
			_user$project$Form_TextInput$View,
			_elm_lang$core$Native_Utils.update(
...
var _user$project$Form_TextInput$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _user$project$Form_TextInput$render = function (_p25) {
	var _p26 = _p25;
	var _p28 = _p26._0;
	var _p27 = _p28.isShown;
	if (_p27 === true) {
		return A2(
			_elm_lang$html$Html$input,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$disabled(_p28.isLocked),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$value(
							_user$project$Form_Value$getValue(_p26._1.value)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Form_TextInput$Input),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Endpoints_AccountDetails_Model$initialModel = {publicKey: _user$project$Form_TextInput$init, isLoading: false, response: _elm_lang$core$Maybe$Nothing};
...
var _user$project$Helpers_String$splitUpper = F4(
	function (isFirst, splitter, toLower, $char) {
		var _p0 = {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Char$isUpper($char),
			_1: toLower
		};
		if ((_p0.ctor === '_Tuple2') && (_p0._0 === true)) {
			if (_p0._1 === true) {
				return isFirst ? _elm_lang$core$String$fromChar(
					_elm_lang$core$Char$toLower($char)) : A2(
					_elm_lang$core$Basics_ops['++'],
					splitter,
					_elm_lang$core$String$fromChar(
						_elm_lang$core$Char$toLower($char)));
			} else {
				return isFirst ? _elm_lang$core$String$fromChar($char) : A2(
					_elm_lang$core$Basics_ops['++'],
					splitter,
					_elm_lang$core$String$fromChar($char));
			}
...
var _user$project$Helpers_String$toWords = function (string) {
	return _elm_lang$core$String$concat(
		A2(
			_elm_lang$core$List$indexedMap,
			F2(
				function (index, $char) {
					return A4(
						_user$project$Helpers_String$splitUpper,
...
var _user$project$Helpers_String$toHyphen = function (string) {
	return _elm_lang$core$String$concat(
		A2(
			_elm_lang$core$List$indexedMap,
			F2(
...
var _user$project$Routes$routeToString = function (page) {
	...
	if (_p0.ctor === 'Endpoints') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'#/endpoints/',
			_user$project$Helpers_String$toHyphen(
...
var _user$project$Helpers_RecordFormatter$Keep = {ctor: 'Keep'};
var _user$project$Helpers_RecordFormatter$Outdent = {ctor: 'Outdent'};
var _user$project$Helpers_RecordFormatter$Indent = {ctor: 'Indent'};
...
var _user$project$Endpoints_Styles$pageTitle = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _user$project$Endpoints_Styles$pageTitleContainer = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A3(
...
var _user$project$Endpoints_Styles$content = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _user$project$Endpoints_Styles$sidebarItemLink = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A4(
...
var _user$project$Endpoints_Styles$sidebarList = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _user$project$Endpoints_Styles$sidebarTitle = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_css$Css$margin2,
...
var _user$project$Endpoints_Styles$sidebar = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _user$project$Endpoints_Styles$body = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$displayFlex,
		_1: {
...
var _user$project$Endpoints_Styles$elmTitle = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
...
var _user$project$Endpoints_Styles$stellarTitle = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$color(
...
var _user$project$Endpoints_Styles$header = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$displayFlex,
		_1: {
...
var _user$project$Endpoints_Styles$layout = _rtfeldman$elm_css$Html_Styled_Attributes$css(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$displayFlex,
		_1: {
...
var _user$project$Endpoints_Styles_ops = _user$project$Endpoints_Styles_ops || {};
_user$project$Endpoints_Styles_ops['?'] = F2(
...
var _user$project$Endpoints_Styles$sidebarItem = function (isSelected) {
	return _rtfeldman$elm_css$Html_Styled_Attributes$css(
		{
			ctor: '::',
			_0: A2(
				_user$project$Endpoints_Styles_ops['?'],
...
var _user$project$Endpoints_View$response = function (response) {
	...
	if (_p0.ctor === 'Nothing') {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Endpoints_Styles$response,
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Endpoints_View$pageTitle = F2(
	function (title, link) {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Endpoints_Styles$pageTitleContainer,
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Endpoints_Styles$pageTitle,
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
							...
							_rtfeldman$elm_css$Html_Styled$button,
							{
								...
								_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(
									_user$project$Endpoints_AccountDetails_MsgFactory$composeMsg(
										A2(_user$project$Endpoints_AccountDetails_Msg$Request, _user$project$Stellar_Endpoint$dummy, _user$project$Stellar_PublicKey$dummy))),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$Stellar_Endpoints_DataForAccount$keyToString = function (_p0) {
	return _user$project$Helpers_String$toHyphen(
				...
				_0: A2(
					...
					},
					{
						...
						_0: _rtfeldman$elm_css$Html_Styled$text(
							_user$project$Helpers_String$toWords(
								_elm_lang$core$Basics$toString(endpoint))),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
